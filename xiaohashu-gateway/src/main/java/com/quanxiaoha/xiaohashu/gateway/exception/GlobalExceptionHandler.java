...
import com.quanxiaoha.xiaohashu.gateway.enums.ResponseEnum;
...
public class GlobalExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        if (ex instanceof NotLoginException) { // 未登录异常
            ...
            // 构建响应结果
            result = Response.fail(ResponseEnum.UNAUTHORIZED.getErrorCode(), "未携带 Token 令牌");
            ...
            result = Response.fail(ResponseEnum.SYSTEM_ERROR);
        }
